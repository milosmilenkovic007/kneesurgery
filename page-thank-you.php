...
<main id="primary" class="site-main hj-thank-you-page">
  <section class="hj-thank-you">
    <div class="hj-thank-you__wrap">
      ...
      <section class="hj-thank-you__card" aria-label="<?php esc_attr_e('Direct contact options', 'kneesurgery'); ?>">
        <h2 class="hj-thank-you__card-title"><?php esc_html_e('Need to talk now?', 'kneesurgery'); ?></h2>
        <p class="hj-thank-you__card-copy"><?php esc_html_e('You can also reach us directly on WhatsApp:', 'kneesurgery'); ?></p>
